...
def predict_on_cracks(input_image, height=227, width=227, save_cracks = False):
    ...
    if pcrack>=0.7:
        print("WARNING!!")
        print("SPEED SHOULD BE < 30 KM/HR")
    elif pcrack>=0.4 and pcrack<0.7:
        print("WARNING!!")
        print("SPEED SHOULD BE < 50 KM/HR")
    elif pcrack<0.2:
        print("NO NEED TO CHANGE SPEED")
    else:
        print("WARNING!!")
        print("SPEED SHOULD BE < 70 KM/HR")
    ## Save output image
...
output_image = predict_on_cracks('sample.jpg', 128, 128)
